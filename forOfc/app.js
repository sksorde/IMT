...
var stage3 = require('./routes/stage3');	//added by Parag
var ply = require('./routes/ply');	//added by Parag
...
app.use('/stage3', stage3);		//added by Parag to filter record by Area = NEW

app.use('/ply', ply);		//added by Parag to filter record by Area = NEW
